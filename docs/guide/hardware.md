...
Basically can be a two-way bridge between the IDE and microcomputer. A
program that works in the emulator can be exported to real hardware,
...
Please note the Import reads tokenised source code and has limited support for disassembling machine code. If you want to hack around on third-party commercial programs/games you need to legally obtain a copy of the source code first.
