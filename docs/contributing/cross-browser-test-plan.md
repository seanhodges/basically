...
| 5.2 | 🤖 partial (`s05`) | File ▸ Load a `.txt` (or legacy `.bas`) file             | Loads into the editor; dialect syntax check runs                                                                                                               |
| 5.3 | **🖐 MANUAL**      | Cancel each dialog (load and save)                       | No error, no state change — in every browser                                                                                                                   |
