...
| ------ | --------------------------------------- | --- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅     | Amstrad CPC 464                         | Z80 | Locomotive BASIC 1.0 | `cpc464`; registered and playable. In-tree bus over the vendored Z80 core in the shared `src/emulator/cpc/` machine: Gate Array (27-colour palette, mode select, ROM paging, 300Hz interrupt), CRTC 6845 raster, 8255 PPI and the AY-3-8912 PSG (shared `src/emulator/ay/`, factored out of the 128K Spectrum). AMSDOS `.bas` + `.cdt` tape + cassette WAV I/O, variable watching, native joystick and the step debugger are all wired — the plan is complete: [dialect-plans/cpc464.md](./dialect-plans/cpc464.md) |
| ✅     | Amstrad CPC 6128                        | Z80 | Locomotive BASIC 1.1 | `cpc6128`; registered and playable. Delegation sibling of the CPC 464 (shared language layer, `src/emulator/cpc/` machine and docs page) adding the eleven BASIC 1.1 keywords behind the variant seam, the PAL's eight 128K RAM configurations and its own BASIC 1.1 workspace table. Tape-only: AMSDOS + the µPD765 FDC + `.dsk` are the remaining follow-up — the plan is complete: [dialect-plans/cpc6128.md](./dialect-plans/cpc6128.md)                                                                        |
