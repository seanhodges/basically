...
| --------------------------------- | ------------ | ---------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Z80.js (Molly Howell)             | Z80 / 8080   | MIT              | `src/emulator/z80/` - vendored, 3 local patches (M1 hook, accessors, ESM export)                  | ZX81, ZX80, ZX Spectrum 48K, ZX Spectrum 128, Amstrad CPC 464, Amstrad CPC 6128 |
