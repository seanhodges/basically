...
| ⬜     | Commodore VIC-20     | 6502 | Commodore BASIC           | In-tree bus over the standalone `src/emulator/6502/` core with a from-scratch frame-approximate VIC-I renderer and 6522 VIAs (shared chip modules come from the PET plan). BASIC V2 is token-identical to the C64's - the language layer is re-exported with a $1001 load address. Staged plan: [`docs/contributing/dialect-plans/vic20.md`](../contributing/dialect-plans/vic20.md).                                                                                                                                                                                                                                              |
