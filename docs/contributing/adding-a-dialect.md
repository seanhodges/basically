...
**Start with the `adding-a-target-system` skill.** It audits the complete
...
under `src/dialects/<id>/`. The skill **plans and scaffolds only** — it does not
...
### Virtual keyboard — key files to reference
