...
| ⬜     | TRS-80 Model I / III       | Z80 | Microsoft Level II BASIC | Simple monochrome 64×16 character display (video RAM at `0x3C00`, all I/O memory-mapped — the simplest Z80 bus); Microsoft Level II BASIC tokenizer (linked-line layout from `0x42E8`, like the C64). Staged plan: [`docs/dialect-plans/trs80.md`](dialect-plans/trs80.md). **ROM is a blocker:** the Level II ROM is copyright Tandy/Microsoft, not public domain — needs a licence check before bundling.                                                   |
