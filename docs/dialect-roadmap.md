...
| ------ | ----------------- | ----- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅     | BBC Micro Model B | 6502  | BBC BASIC II | `bbcmicro`; reference jsbeeb integration. Cassette WAV export (CFS over Kansas City Standard FSK)                                                                                         |
| ✅     | BBC Master        | 65C12 | BBC BASIC IV | `bbcmaster`; reuses the whole BBC language layer (BASIC IV shares BASIC II's tokens), including the CFS cassette WAV export — only the jsbeeb model differs. MOS 3.20 ROM already bundled |
...
| ✅     | Sinclair ZX Spectrum 48K   | Z80 | Sinclair BASIC           | `zxspectrum`; `.TAP` format and cassette WAV export (standard ROM tape encoding, derived from the same tape blocks)                                                                                                                                                                                                             |
