    ...
    <div className={styles.settingsForm}>
      ...
      {tab === 'input' && (
        <div role="tabpanel" className={styles.tabPanel}>
          ...
          <p>
            Long-press a control on the on-screen gamepad to remap it to a key
            on the current machine. On a machine whose joystick has a single
            fire button, the secondary (B) button only acts in Key mapped mode.
          </p>
        </div>
      )}
      ...
      {tab === 'ai' && (
        <div role="tabpanel" className={styles.tabPanel}>
          ...
          <p className={dialog.modalWarning}>
            ...
            localStorage and sent only to {provider.apiHost}. Don&apos;t use
