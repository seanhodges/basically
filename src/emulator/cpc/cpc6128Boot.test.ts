 ...
 * 1.1), the 6128 half of the cpcBoot suite. Skips until the combined 32K
 * `cpc6128.rom` is present at public/roms/cpc/cpc6128.rom.
 */
...
/** OCR the text screen through the OS ROM's own character matrices at &3800. */
