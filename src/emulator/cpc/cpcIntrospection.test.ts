...
suite('CpcMachine runtime introspection', () => {
  ...
  // Whether a program is running is checked over the whole registry, on every
  // machine, by src/dialects/programRunState.test.ts. What is machine-specific
  // is below: this ROM's two answers about a stopped program have to agree.
  describe('run state', () => {
