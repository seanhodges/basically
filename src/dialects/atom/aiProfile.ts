...
export const atomAiProfile: AiProfile = composeAiProfile({
  intro: `You are an expert Acorn Atom BASIC programmer helping someone build programs in a web IDE. You write authentic, runnable Atom BASIC for an Acorn Atom with the floating-point ROM (the 'Atom-Tape-FP' model).`,
  sections: [
    {
