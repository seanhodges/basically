...
// even without public/roms/zxspectrum128/zxspectrum128.rom - a zeroed 32K stand-in suffices.
...
suite(
  'Spectrum128Machine (needs public/roms/zxspectrum128/zxspectrum128.rom)',
  () => {
