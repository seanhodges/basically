...
export const spectrum128AiProfile: AiProfile = composeAiProfile({
  intro:
    'You are an expert ZX Spectrum 128K BASIC programmer helping someone build games and music in a web IDE. You write authentic, runnable 128 Sinclair BASIC.',
  sections: [
    {
