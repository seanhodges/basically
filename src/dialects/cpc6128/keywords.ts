 ...
 * COPYCHR$, CURSOR, DEC$, DERR, FILL, FRAME, GRAPHICS, GRAPHICS PAPER,
 * GRAPHICS PEN, MASK and ON BREAK CONT - twelve, counting the bare GRAPHICS
 * prefix token (&DE) alongside the two forms it introduces - which the shared
 * table carries tagged
