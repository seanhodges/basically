...
160 IF bx<1 OR bx>30 THEN LET dx=-dx: BEEP .008,-12
170 IF by<2 THEN LET dy=-dy: BEEP .008,-12
180 IF by=2 THEN LET s=s+1: BEEP .008,24
190 IF by<19 THEN GO TO 80
200 IF bx>=x AND bx<=x+3 THEN LET dy=-dy: BEEP .008,-12
210 IF by<21 THEN GO TO 80
215 FOR n=30 TO -30: BEEP .016,n: NEXT n
