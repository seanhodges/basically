...
describe('altair8800 memory', () => {
  it('copies the interpreter into RAM at 0x0000, where a POKE can reach it', () => {
    const memory = new Altair8800Memory(64);
  ...
  it('fits fewer boards for the smaller RAM settings', () => {
    expect(new Altair8800Memory(16).ramTop).toBe(0x3fff);
    expect(new Altair8800Memory(32).ramTop).toBe(0x7fff);
  });
