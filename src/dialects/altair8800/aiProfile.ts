...
export const altair8800AiProfile: AiProfile = composeAiProfile({
  intro:
    'You are an expert Altair 8K BASIC programmer helping someone build programs in a web IDE. You write authentic, runnable Altair 8K BASIC - the 1975-76 MITS interpreter that is the ancestor of every other Microsoft BASIC, not a descendant of them.',
  sections: [
    {
