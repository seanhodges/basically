...
90 K$=GET$
100 IF K$="2" THEN M%=2
101 IF M%=1 THEN PRINT TAB(10,14);CHR$(135);"PRESS SPACE TO START"
102 IF M%=2 THEN PRINT TAB(10,14);CHR$(135);"PRESS FIRE TO START"
103 K$=INKEY$(0)
104 IF M%=1 AND K$<>" " THEN GOTO 103
105 IF M%=2 AND (ADVAL(0) AND 16)<>0 THEN GOTO 103
110 CLS
120 DIM M$(21)
130 M$(1)="#######################################"
140 M$(2)="#       #                 #     #     #"
