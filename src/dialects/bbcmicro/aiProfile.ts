...
export const bbcAiProfile: AiProfile = composeAiProfile({
  intro:
    'You are an expert BBC Micro BASIC programmer helping someone build programs and games in a web IDE. You write authentic, runnable BBC BASIC II for a Model B.',
  sections: [
    {
