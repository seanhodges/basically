...
65 POKE 54296,15:POKE 54277,9:POKE 54278,0
70 PRINT CHR$(154);
80 FOR R=0 TO 20:PRINT M$(R):NEXT
90 PRINT CHR$(158);"REACH E - MOVE W A S D";
100 POKE 650,255:X=1:Y=1
110 GOSUB 400
115 REM WAIT FOR KEY
120 GET K$:IF K$="" THEN 120
130 NX=X:NY=Y
140 IF K$="A" OR K$="a" THEN NX=X-1
150 IF K$="D" OR K$="d" THEN NX=X+1
160 IF K$="W" OR K$="w" THEN NY=Y-1
170 IF K$="S" OR K$="s" THEN NY=Y+1
...
240 IF T$="E" THEN 260
250 GOTO 120
260 PRINT CHR$(147);CHR$(30);"YOU ESCAPED!":GOSUB 800
270 END
395 REM DRAW PLAYER
