...
121 PRINT
122 IF MD=1 THEN PRINT CHR$(158);"   PRESS SPACE TO START"
123 IF MD=2 THEN PRINT CHR$(154);"   PRESS FIRE TO START"
124 GET K$
125 IF MD=1 AND K$<>CHR$(32) THEN 124
126 IF MD=2 AND (PEEK(56320) AND 16)<>0 THEN 124
130 PRINT CHR$(147);
140 DIM M$(20)
...
190 IF MD=1 THEN PRINT CHR$(158);"REACH E - W A S D";
195 IF MD=2 THEN PRINT CHR$(158);"REACH E - JOYSTICK PORT 2";
200 X=1:Y=1
210 GOSUB 360
220 GOSUB 400
230 NX=X:NY=Y
