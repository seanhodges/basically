...
300 T=PEEK(SC+40*NY+NX)
310 IF T=35 THEN 220
320 POKE SC+40*Y+X,32
330 X=NX:Y=NY
340 GOSUB 360
350 IF T=5 THEN PRINT CHR$(147);CHR$(30);"YOU ESCAPED!":GOSUB 800:END
355 GOTO 220
360 REM DRAW PLAYER
365 POKE SC+40*Y+X,81:POKE SC+40*Y+X+CO,7:RETURN
400 REM READ MOVE
410 LF=0:RT=0:UP=0:DN=0
420 IF MD=1 THEN GOSUB 450
...
440 RETURN
450 KB=PEEK(197)
451 IF KB=10 THEN LF=1
452 IF KB=18 THEN RT=1
453 IF KB=9 THEN UP=1
454 IF KB=13 THEN DN=1
458 RETURN
500 DATA "#######################################"
510 DATA "#       #                 #     #     #"
520 DATA "####### ### ########### # # # ### ### #"
