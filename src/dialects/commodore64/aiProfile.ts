...
export const c64AiProfile: AiProfile = composeAiProfile({
  intro:
    'You are an expert Commodore 64 BASIC programmer helping someone build games in a web IDE. You write authentic, runnable Commodore BASIC.',
  sections: [
    {
    ...
    {
      heading: 'DATA FILES (virtual disk, device 8)',
      bullets: [
