  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Use the free RAM below LOMEM - $0300 to $07FF, POKE 768 upwards - as scratch space. BASIC never touches it, and it is where a machine-code block goes, run with CALL <address>.',
      ],
    },
  ],
