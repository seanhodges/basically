...
- [ ] 1.1 `docs/.vitepress/theme/components/DialectCompare.vue`: reorder the
...
- [ ] 3.2 `npm test`
- [ ] 3.3 `npm run lint` and `npm run format:check`
- [ ] 3.4 `npm run docs:build`
- [ ] 3.5 `npm run e2e:chromium -- e2e/porting-guidance` — the order assertions
